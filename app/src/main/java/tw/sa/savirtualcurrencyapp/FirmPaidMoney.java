...
public class FirmPaidMoney extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.firm_paid_money);

        Toolbar toolbar = (Toolbar) findViewById(R.id.paid_money_toolbar);
                ...
                if (qrCodes.size() != 0) {
                    ...
                    textView.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            intent.setClass(FirmPaidMoney.this, FirmPaidProcess.class);
