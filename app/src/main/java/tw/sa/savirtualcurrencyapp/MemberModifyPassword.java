...
public class MemberModifyPassword extends AppCompatActivity {
...
//                startActivity(new Intent(MemberModifyPassword.this, MemberModifyPerson.class));
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            try {
                                ...
                                // 資料庫處理要求
                                String sql = "UPDATE `member` SET `密碼`='" + N_PW + "' WHERE `會員ID` = '" + memberID + "' AND `密碼` = '" + O_PW + "'";
                                Log.v("DB", sql);
